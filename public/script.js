document.addEventListener("DOMContentLoaded", function() {
  ...
  fetchAndRenderProducts('http://localhost:3000/api/newproduct', '#newproduct .container');

  // Fetch bestseller products and render
  fetchAndRenderProducts('http://localhost:3000/api/bestseller', '#bestseller .container');
